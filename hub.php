...
<style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-item.logout:hover .nav-icon { background: rgba(255,126,179,.12); }
    ...
    .user-card:hover { border-color: #3a3a45; }
    .user-avatar-sm {
    ...
    .toggle-icon svg { transition: transform var(--transition); }
    ...
    .avatar-dropdown:hover { display: block; }
    ...
    .dropdown-info .d-name { font-size: 0.85rem; font-weight: 600; color: var(--text); }
    .dropdown-info .d-email { font-size: 0.72rem; color: var(--muted); margin-top: 2px; }
    ...
    .dropdown-item.logout-item:hover { background: rgba(255,126,179,.08); color: var(--danger); }
    ...
    .stat-value { font-family: 'Syne', sans-serif; font-size: 2rem; font-weight: 800; letter-spacing: -0.04em; }
    ...
    .panel-title { font-family: 'Syne', sans-serif; font-weight: 700; font-size: 1rem; letter-spacing: -0.01em; }
    ...
    .chip { display: inline-block; padding: 3px 10px; border-radius: 20px; font-size: 0.72rem; font-weight: 600; }
    ...
    .modal h2 { font-family: 'Syne', sans-serif; font-size: 1.1rem; font-weight: 700; margin-bottom: 8px; }
    ...
    .btn-danger { background: var(--danger); color: #0e0e11; }
</style>
</head>
<body>
...
<nav class="sidebar" id="sidebar">
    ...
    <div class="nav-section">
        ...
        <a class="nav-item logout" href="#" id="sidebarLogout">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
    ...
    <div style="margin-top:auto;">
        <div class="user-card">
            ...
            <div class="user-info">
                <div class="user-name">Ana Lima</div>
            ...
            <div class="avatar-wrap">
                ...
                <div class="avatar-dropdown">
                    <div class="dropdown-info">
                        <div class="d-name">Ana Lima</div>
                        <div class="d-email">ana@estudante.ifgoiano.edu.br</div>
                    </div>
                    <a class="dropdown-item" href="#" data-page="configuracoes" id="dropdownConfig">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <circle cx="12" cy="12" r="3"/>
                            <path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06A1.65 1.65 0 0 0 4.68 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 9 4.68a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06A1.65 1.65 0 0 0 19.4 9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>
                        </svg>
                    ...
                    <a class="dropdown-item logout-item" href="#" id="dropdownLogout">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/>
                            <polyline points="16 17 21 12 16 7"/>
                            <line x1="21" y1="12" x2="9" y2="12"/>
    ...
    <div class="content">
        ...
        <div class="page active" id="page-dashboard">
            ...
            <div class="grid2">
                    ...
                    <div class="panel">
                        ...
                        <div class="table-wrap">
                            <table>
                                ...
                                <tbody>
                                    <tr><td>Redesign App</td><td>Ana Lima</td><td>12 Mai</td><td><span class="chip chip-green">Em dia</span></td></tr>
                                    <tr><td>API v3</td><td>Bruno Costa</td><td>28 Mai</td><td><span class="chip chip-blue">Em andamento</span></td></tr>
                                    <tr><td>Campanha Q2</td><td>Carla Dias</td><td>05 Mai</td><td><span class="chip chip-red">Atrasado</span></td></tr>
                                    <tr><td>Dashboard BI</td><td>Diego Nunes</td><td>20 Jun</td><td><span class="chip chip-green">Em dia</span></td></tr>
                                </tbody>
                            </table>
                        </div>
                    </div>
                ...
                <div>
                    <div class="panel" style="margin-bottom:20px;">
                        <div class="panel-header"><span class="panel-title">Ações Rápidas</span></div>
                    ...
                    <div class="panel">
                        <div class="panel-header"><span class="panel-title">Performance Semanal</span></div>
                        <div class="bar-chart">
                            <div class="bar-wrap"><div class="bar" style="height:45%;background:rgba(200,241,53,.3)"></div><div class="bar-label">S</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:70%;background:var(--accent)"></div><div class="bar-label">T</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:55%;background:rgba(200,241,53,.3)"></div><div class="bar-label">Q</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:90%;background:var(--accent)"></div><div class="bar-label">Q</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:65%;background:rgba(200,241,53,.3)"></div><div class="bar-label">S</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:30%;background:rgba(200,241,53,.2)"></div><div class="bar-label">S</div></div>
                            <div class="bar-wrap"><div class="bar" style="height:15%;background:rgba(200,241,53,.15)"></div><div class="bar-label">D</div></div>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="modal-overlay" id="logoutModal">
    <div class="modal">
        ...
        <h2>Sair da conta?</h2>
        <p>Você será redirecionado para a tela de login e precisará entrar novamente.</p>
        <div class="modal-actions">
            <button class="btn btn-ghost" id="cancelLogout">Cancelar</button>
            <a class="btn btn-danger" href="logout.php">Confirmar saída</a>
        </div>
    </div>
</div>
...
<script>
    ...
    document.getElementById('dropdownConfig').addEventListener('click', e => {
        e.preventDefault();
    ...
    document.getElementById('dropdownLogout').addEventListener('click', openLogout);
    document.getElementById('cancelLogout').addEventListener('click', () => modal.classList.remove('open'));
